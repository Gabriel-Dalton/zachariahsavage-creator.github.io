...
const FLOW_MICO_ITEMS = [
  "Assets/optimized/MICO/4.webp",
  "Assets/optimized/MICO/12.webp",
  "Assets/optimized/MICO/2.webp",
];
...
const FULL_GALLERY_MICO_HARD_LUCK = {
  ...
  sources: [
    "Assets/optimized/MICO/4.webp",
    "Assets/optimized/MICO/3.webp",
    "Assets/optimized/MICO/5.webp",
    "Assets/optimized/MICO/6.webp",
    "Assets/optimized/MICO/7.webp",
    "Assets/optimized/MICO/8.webp",
    "Assets/optimized/MICO/10.webp",
    "Assets/optimized/MICO/11.webp",
    "Assets/optimized/MICO/12.webp",
    "Assets/optimized/MICO/14.webp",
    "Assets/optimized/MICO/15.webp",
    "Assets/optimized/MICO/16.webp",
    "Assets/optimized/MICO/17.webp",
    "Assets/optimized/MICO/19.webp",
    "Assets/optimized/MICO/1 copy.webp",
    "Assets/optimized/MICO/2.webp",
    "Assets/optimized/MICO/9.webp",
    "Assets/optimized/MICO/20.webp",
    "Assets/optimized/MICO/21.webp",
    "Assets/optimized/MICO/13.webp",
    "Assets/optimized/MICO/18.webp",
  ],
};
...
const FULL_GALLERY_PATH_ASPECTS = {
  ...
  "Assets/optimized/MICO/1 copy.webp": 1.333,
  "Assets/optimized/MICO/10.webp": 0.75,
  "Assets/optimized/MICO/11.webp": 0.75,
  "Assets/optimized/MICO/12.webp": 0.75,
  "Assets/optimized/MICO/13.webp": 1.5,
  "Assets/optimized/MICO/14.webp": 0.75,
  "Assets/optimized/MICO/15.webp": 0.75,
  "Assets/optimized/MICO/16.webp": 0.75,
  "Assets/optimized/MICO/17.webp": 0.75,
  "Assets/optimized/MICO/18.webp": 1.5,
  "Assets/optimized/MICO/19.webp": 0.75,
  "Assets/optimized/MICO/2.webp": 1.333,
  "Assets/optimized/MICO/20.webp": 1.333,
  "Assets/optimized/MICO/21.webp": 1.333,
  "Assets/optimized/MICO/3.webp": 0.75,
  "Assets/optimized/MICO/4.webp": 0.75,
  "Assets/optimized/MICO/5.webp": 0.75,
  "Assets/optimized/MICO/6.webp": 0.75,
  "Assets/optimized/MICO/7.webp": 0.75,
  "Assets/optimized/MICO/8.webp": 0.75,
  "Assets/optimized/MICO/9.webp": 1.333,
};
...
const FLOW_REWARM_MIN_INTERVAL_MS = 200;
const GALLERY_PREVIEW_REWARM_MIN_INTERVAL_MS = 200;
const CONTACT_REWARM_MIN_INTERVAL_MS = 200;
...
const GALLERY_FOLDER_COLLAPSE_MS = 420;
const GALLERY_FOLDER_NAV_SCROLL_MS = 280;
...
function animateScrollToScrollTarget(getTargetFn, durationMs) {
  const reduceMotion = window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches;
  if (reduceMotion) {
    const endScroll = getTargetFn();
    if (endScroll !== null) setPageScrollTop(endScroll);
    return;
  }
  ...
  const tick = (now) => {
    ...
    const endScroll = getTargetFn();
    if (endScroll === null) return;
    setPageScrollTop(startScroll + (endScroll - startScroll) * eased);
    if (t < 1) {
      requestAnimationFrame(tick);
    } else {
      setPageScrollTop(endScroll);
    }
  };
  requestAnimationFrame(tick);
}

/** Scroll so the folder ends centered in the viewport, in sync with collapse. */
function animateScrollToFolderDuringCollapse(sectionEl, durationMs = GALLERY_FOLDER_COLLAPSE_MS) {
  if (!sectionEl) return;
  animateScrollToScrollTarget(
    () => getGalleryFolderCenteredScrollTarget(sectionEl),
    durationMs
  );
}

/** Nav selection: center the folder's first two preview images in the viewport. */
function animateScrollToFolderPreview(sectionEl, durationMs = GALLERY_FOLDER_NAV_SCROLL_MS) {
  if (!sectionEl) return;
  animateScrollToScrollTarget(
    () => getGalleryFolderPreviewCenteredScrollTarget(sectionEl),
    durationMs
  );
}
...
function createPortfolioDateGroupSection(folderDef, gap, isFullGalleryPage) {
  ...
  if (hasCollapsibleExtra) {
    ...
    const setFolderExpanded = (open) => {
      ...
      animateScrollToFolderDuringCollapse(section);
    };
  ...
  folders.forEach((folder) => {
    ...
    if (section) {
      ...
      link.addEventListener("click", (event) => {
        ...
        animateScrollToFolderPreview(section, GALLERY_FOLDER_NAV_SCROLL_MS);
      });
    }
...
window.addEventListener("load", async () => {
  ...
  function scheduleFlowRemeasure() {
    ...
    resizeTimeout = setTimeout(() => {
      ...
      if (!rowsState || !flowReady) {
        if (rowsState) measureAndPosition(rowsState, { forceRebuild: true });
      } else {
        updateFlowLayoutWidths(rowsState);
      }
      refreshFlowTrackAnimations();
